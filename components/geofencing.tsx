        ...
        <div className="bg-white/30 p-12 shadow-xl ring-1 ring-gray-900/5 rounded-lg backdrop-blur-lg max-w-xl mx-auto w-full">
            ...
            <div className="">
                {showdata ? (
                    <>
                        <div className="flex items-center justify-between py-3">
                            <div><h3>Patient is in your area</h3></div>
                            <p>{patients[0].name}</p>
                        ...
                        <div className="flex items-center justify-between py-3">
                            <div><h3>Patient is in your area</h3></div>
                            <p>{patients[1].name}</p>
                            <p>{patients[1].email}</p>
                            <p>{patients[1].id_center}</p>
                        </div>

                        <div className="flex items-center justify-between py-3">
                            <div><h3>Patient is in your area</h3></div>
                            <p>{patients[2].name}</p>
                            <p>{patients[2].email}</p>
                            <p>{patients[2].id_center}</p>
                        </div>
                    </>
                ) : (
                    <div className="flex items-center justify-between py-3">
                        <div><h3>Patient is not in your area</h3></div>
                    </div>
                )}
