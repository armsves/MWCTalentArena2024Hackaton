		...
		<>
			<div className='bg-white/30 p-12 shadow-xl ring-1 ring-gray-900/5 rounded-lg backdrop-blur-lg max-w-screen-xl mx-auto w-full'>
				<div className='flex justify-between items-center mb-4'>
					...
					<div className='space-y-1 p-3'>
						<h2 className='text-xl font-semibold'>{medicalCenters[0].name}</h2>
					</div>
					<div className='space-y-1 p-3'>
						<h2 className='text-xl font-semibold'>{medicalCenters[1].name}</h2>
					</div>
					<div className='space-y-1 p-3'>
						<h2 className='text-xl font-semibold'>{medicalCenters[2].name}</h2>
					</div>
				</div>
				<div className=''>
					{patients &&
